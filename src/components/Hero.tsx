    ...
    <section className="relative pt-32 pb-16 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center justify-between gap-8">
          <div className="hidden lg:block flex-shrink-0 w-80 h-80 opacity-0 animate-slideInLeft">
            <spline-viewer
              url="https://prod.spline.design/w4JyYvxGtW50XcBZ/scene.splinecode"
          ...
          <div className="hidden lg:block flex-shrink-0 w-80 h-80 opacity-0 animate-slideInRight">
            <spline-viewer
              url="https://prod.spline.design/w4JyYvxGtW50XcBZ/scene.splinecode"
              style={{ width: '100%', height: '100%' }}
            ></spline-viewer>
